...
export default function BuyerRfmPage() {
  ...
  return (
    <div>
      <h1 className="font-bold text-xl mb-3">공급업체 RFM 분석 (Buyer)</h1>
            ...
            <tbody>
              {rows.map((r, i) => (
                <tr key={i} className="hover:bg-neutral-50">
                  ...
                  <td className="border px-3 py-2 text-right">{r.monetary?.toLocaleString() ?? "-"}</td>
                </tr>
              ))}
            </tbody>
          </table>
